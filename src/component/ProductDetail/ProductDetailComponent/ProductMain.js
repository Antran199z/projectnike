...
import * as AtionType from "../../Cart/module/contants/contants";
import ModalTrasition from './Modal'
...
function ProductMain({ detailProduct, getIndexImg, indexPress }) {
