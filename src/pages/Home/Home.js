...
import * as action from "../../component/ListProduct/Module/Action/action"
const HomePage = () => {
  ...
  return (
    <React.Fragment>
        <MainContainer
         carouselImg={carouselImg} titleTrending={titleTrending} dataTrending={dataTrending} dataMoreNike={dataMoreNike} merchMenu={merchMenu}/>
    </React.Fragment>
  )
}
//muon truyen props o dau thi import o cho do
